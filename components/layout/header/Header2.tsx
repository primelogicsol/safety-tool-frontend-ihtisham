...
export default function Header2({ scroll, handlePopup, handleMobileMenu, isSidebar, handleSidebar }: Header2Props) {
    return (
        <>
                        ...
                        <div className="main-menu-two__wrapper-inner">
                            <div className="main-menu-two__left">
                                <div className="main-menu-two__logo">
                                    <Link href="/">
                                        <Image src="/assets/images/resources/logo-2.png" alt="Logo" width={150} height={50} />
                                    </Link>
                                </div>
                            </div>
